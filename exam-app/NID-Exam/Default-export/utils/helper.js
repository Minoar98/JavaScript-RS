...
// Named export
export const deleteNID = (userNID, nidNo) => {
  // user is found
  if (userNID.nidNo === nidNo) {
    userNID = null;
...
// Named export
export const calculateAgeBasedOnCurrentYear = (userNID, nidNo) => {
  const { dob } = userNID;
...
// export const obj = {
//   createNID: createNID,
//   showNIDInfo: showNIDInfo,
//   updateNID: updateNID,
//   deleteNID: deleteNID,
//   calculateAgeBasedOnCurrentYear: calculateAgeBasedOnCurrentYear,
// };
